<div class="w3-content">
    ...
    <p><a class="w3-btn w3-green w3-round-large" href="<?php echo PROTOCOL . BASE_URI; ?>/pub/doc/BVRC_Membership_Form18_19.docx"><i class="w3-xlarge fa fa-file-word-o" aria-hidden="true"></i>&nbsp; BVRC_Membership_Form18_19.docx</a>
       <a class="w3-btn w3-green w3-round-large" href="<?php echo PROTOCOL . BASE_URI; ?>/pub/doc/BVRC_Membership_Form18_19.pdf"><i class="w3-xlarge fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp; BVRC_Membership_Form18_19.pdf</a>
    <p>Print them out, fill them in, and then you can submit the form at the shed, or send it to us by post.

    <div class="w3-panel w3-padding w3-leftbar w3-border-blue w3-pale-blue"><strong>Important Note: </strong>You may still pay online even if you submit the form manually. See below for details.</div>

    <h2>Volunteer Online</h2>
