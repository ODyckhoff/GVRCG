<div class="w3-content">
    ...
    ?>
    <p>Don't have an account? <a href="<?php echo PROTOCOL . BASE_URI; ?>/members/register">Register here</a></p>
    <div class="w3-container w3-card-4">
    <form action="<?php echo PROTOCOL . BASE_URI; ?>/action/auth" method="POST">
