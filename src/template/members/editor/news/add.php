...
?>
    <h2>Adding News</h2>
        ...
        <div class="w3-container w3-card-4">
            <form method="POST" action="<?php echo PROTOCOL . BASE_URI; ?>/action/addnews">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="summary" type="text">
                    </div>
                </div>
                <div class="w3-row w3-section">
                    <b>Content</b>
                ...
                <div class="w3-row w3-section">
                    <textarea class="w3-input w3-border w3-round-large" name="content"></textarea>
                </div>
                <div class="w3-row w3-section">
                    <input class="w3-btn w3-round green" type="submit" value="Publish News" />
                </div>
            </form>
        </div>
    </div>
