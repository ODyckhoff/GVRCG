<div class="w3-container">
    <h1><?php echo $text->get_text('therail'); ?></h1>
    <h2><?php echo $text->get_text('map'); ?></h2>
    <p>Many thanks to Michael Fox for producing the map.</p>
...
Formerly part of the Llynvi and Ogmore Railway (L&amp;OR) and built by the Great Western Railway (GWR), the line was formerly used for freight and passenger services, with most of the track still in place between Brynmenyn and Pontycymer.
            ...
            <p>
The Garw Valley Line opened on 25 October 1876. Within 10 years of opening, four collieries and some associated drift mines were serviced by the Garw Valley line, producing and hence shipping 4,000 tonnes of coal per day. In 1906 the Glengarw Colliery opened, which by 1911 was producing 1000 tonnes of coal per day.
            </p>

            <p>
Most of the traffic was coal, but stations were constructed at Llangeinor, Pontyrhyl, Pontycymer and Blaengarw after the L&amp;OR was absorbed into the GWR. The system of lines up the Llynfi, Ogmore and Garw valleys was hence known as the Tondy Valley Lines Division. Passenger services operated for some time until bus services took over most of the passengers, resulting in the eventual cessation of passenger services in 1953.
            </p>

            <p>
The entirety of the Tondu Valley Lines Division was closed from 1985 after the end of the UK miners' strike of 1994-1985. The last working colliery in the Garw Valley, the Ocean Colliery, closed in 1985, which resulted in the last coal train running on the Garw in 1986. The Ogmore line was lifted, and a cycle track put in its place. The Llynfi line was reopened as far as Maesteg to passengers in 1992.
            </p>
-->
<p>
