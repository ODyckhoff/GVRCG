<div class="w3-container w3-row-padding w3-margin">
    <div class="w3-container w3-quarter">
        <a href="<?php echo PROTOCOL . BASE_URI; ?>/events">
        ...
        <br />
        <a href="<?php echo PROTOCOL . BASE_URI; ?>/members/register">
    ...
    <img class="w3-card-12 w3-image" src="<?php echo PROTOCOL . BASE_URI; ?>/pub/img/workers.jpg" />
    ...
    <div class="w3-container w3-quarter">
        <a href="<?php echo PROTOCOL . BASE_URI; ?>/funding">
        <div class="w3-card-12 w3-text-white green w3-large w3-center w3-padding">
        ...
        <br />
        <a href="<?php echo PROTOCOL . BASE_URI; ?>/contact">
        <div class="w3-card-12 w3-text-white green w3-large w3-center w3-padding">
...
<!--<div class="w3-margin w3-row-padding">
    ...
    <div class="w3-container green w3-text-white w3-center w3-half w3-padding">
            <img src="<?php echo PROTOCOL . BASE_URI; ?>/pub/img/9660-brynmenyn.png" width="60%" class="w3-round w3-center" />
